...
- There are 18,346 candidate genes linked to the phenotypes
...
```
The above returns 29 species of ictalurid catfishes and 115 anatomical entities for fins and their parts.  
...
Looking at ‘Taxon annotations’, you will find that there are zero phenotypes, i.e., no asserted character states to ‘pelvic fin present’.  Now click the ‘inferred presence’ radio button under Phenotypic quality.  You will now see two phenotypes for this taxon in the KB.  
...
We can query the KB for a presence-absence dependency matrix for a specified set of anatomical structures. The dependency matrix is derived from knowledge of structural relationships among entities encoded in the ontology. In the example below, the presence of 'pelvic splint' implies the presence of 'pelvic fin' (because 'pelvic splint' is part_of 'pelvic fin'). 

...
**Quality** - A term that describes how an entity varies in its features (e.g., shape, size, color…). Qualities are represented by terms from the [PATO ontology]
...
**Taxon annotations**. Phenotypes that are linked to taxa.

[Phenoscape Knowledgebase] (link to kb.phenoscape.org)

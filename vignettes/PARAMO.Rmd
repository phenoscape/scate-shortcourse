...
anatomical_details <- lapply(traits, anatomy_term_info) # Query over traits and get anatomical details 
...
corhmm.fits <- amalgamated_fits_corHMM(td.comb, amal.deps, model = "ER")
```

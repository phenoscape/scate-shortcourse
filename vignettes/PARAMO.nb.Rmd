...
The table that prints out shows the number of taxa for which there is data in the KB ( _coverage_ ) and the proportion of taxa ( _average_ ) for which the trait is present (all of these are binary, presence/absence characters). This dataset is too big for our demonstration purposes. So let's filter down to a smaller set of traits that will illustrate our process. 
